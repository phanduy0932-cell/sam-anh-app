...
function QuoteTab({ card, input, label, quoteForm, setQuoteForm, updateQuoteRoute, updateQuoteVehicle, quoteRoute, quoteCalc }) {
 ...
 <div className="space-y-3">
  <div>
    <div>
  <div className={label}>Chọn xe</div>
  <select
    className={input}
    value={costForm.vehicleId || ""}
    onChange={(e) =>
      setCostForm({ ...costForm, vehicleId: e.target.value })
    }
  >
...
/>
  ...
  onChange={e => setCostForm({ ...costForm, driverSalary: e.target.value })}
/>
          </div>

          <div>
            <div className={label}>Bảo dưỡng</div>
            <input
              className={input}
              inputMode="numeric"
              value={costForm.maintenanceCost}
              onChange={e => setCostForm({ ...costForm, maintenanceCost: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={e => setCostForm({ ...costForm, tollCost: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={e => setCostForm({ ...costForm, otherCost: e.target.value })}
            />
          </div>
